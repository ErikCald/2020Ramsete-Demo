...
public class RobotContainer {
    ...
    public Command getAutonomousCommand() {
        ...
        Trajectory forwardAndRightTraj = TrajectoryGenerator.generateTrajectory(
            new Pose2d(0, 0, new Rotation2d(0)),
            List.of(new Translation2d(1.0, 0.5), new Translation2d(2, 0.5)),
            new Pose2d(2.5, 0.5, Rotation2d.fromDegrees(0)),
            getConfig());

        Trajectory farForwardAndRightTraj = TrajectoryGenerator.generateTrajectory(
            new Pose2d(0, 0, new Rotation2d(0)),
            List.of(),
            new Pose2d(2.2, 0.75, new Rotation2d(0)),
            getConfig());
            
        m_robotDrive.zeroHeading();
        m_robotDrive.resetOdometry(new Pose2d(0, 0, new Rotation2d(0)));

        RamseteCommand ramseteCommand = newRamseteCommand(farForwardAndRightTraj);
